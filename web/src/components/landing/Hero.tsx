    ...
    <div className="relative mx-auto px-12 py-10 lg:py-16">
      <div className="text-center">
        ...
        <p className="text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto mb-8">
          The ultimate scoreboard for real-time game management. Track scores, manage teams, and share live updates — all in one beautiful interface.
        </p>
...
const QuickStart: React.FC = () => {
  ...
  return (
    <div className="w-full px-12 pb-10 lg:pb-16">
      <div className="relative bg-gradient-to-r from-violet-600 to-indigo-600 rounded-3xl p-4 lg:px-12 lg:py-16">
