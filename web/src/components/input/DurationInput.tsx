      ...
      <div className="relative">
        ...
        <div className="relative">
          <input
            ...
            required={required}
            disabled={disabled}
            className={`block w-full rounded-2xl border-2 border-gray-400 bg-white px-4 pt-8 pb-3 pr-24 text-transparent focus:border-gray-900 focus:outline-none sm:text-lg transition-colors ${
              disabled 
